...
*/
    ...
    Sim.register("oncast", function(data) {
      ...
      if (data.offensive && elem && elems[elem]) {
        if (!Sim.getBuff(elems[elem])) {
          ...
          Sim.addBuff("tal_6pc", {dmgmul: 3000}, {maxstacks: 4, duration: 480});
  ...
  affixes.set_nightmares_2pc = function() {
    ...
    Sim.addBaseStats({dmgmul: 500 * Sim.stats.info.ancients, dmgred: 4 * Sim.stats.info.ancients});
  };
